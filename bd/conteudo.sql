...
VALUES
	...
	("success", "perfil_cliente",
		"Alterações salvas comsucesso!",
		"Changes savedwith success!",
		"¡Cambios guardados comsucesso!"),
	...
	("perfil_erronome", "perfil_cliente",
		...
		"Al menos 3 caracteres requeridos."),
	...
	("perfil_erroemail2", "perfil_cliente",
		...
		"Este e-mail ya está siendo utilizado."),
	...
	("perfil_errofone", "perfil_cliente",
		...
		"Please enter a valid phone number. (DDD required)",
		"Introduzca un teléfono válido. (el DDD es necesario)"),
	...
	("perfil_erro_newsenha", "perfil_cliente",
		...
		"Su nueva contraseña no puede ser igual a la contraseña antigua."),
	...
	("perfil_orcamento_txt1", "perfil_cliente",
		"PT - The people listed here are contacts you've uploaded to Instagram. To remove your synced contacts, tap Delete All.",
		"EN - The people listed here are contacts you've uploaded to Instagram. To remove your synced contacts, tap Delete All.",
		"ES - The people listed here are contacts you've uploaded to Instagram. To remove your synced contacts, tap Delete All."),
