      ...
      <div class="navbar-collapse collapse" id="navbar12">
        ...
        <ul class="navbar-nav mx-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" style="max-width: 140px">
              <a class="dropdown-item" href="printer1.php">E1260T</a>
              <a class="dropdown-item" href="printer2.php">Phylos</a>
              <a class="dropdown-item" href="printer3.php">Core E3</a>
            </div>
          </li>
          <li class="nav-item dropdown">
        ...
        <div id="menu-left" class="w-25">
          <ul class="navbar-nav float-lg-right">
            <li class="nav-item"> <a class="nav-link" href="#">Logar</a></li>
            <li class="nav-item"> <a class="nav-link text-primary" href="#">Cadastrar</a></li>
            <li class="nav-item dropdown">
