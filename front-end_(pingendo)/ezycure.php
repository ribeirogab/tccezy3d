    ...
    <div class="container">
      <div class="row">
        <div class="px-md-5 col-md-8">
          ...
          <p class="mb-3">I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies</p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="ml-auto bg-white text-dark p-5 col-lg-6 col-md-8">
          ...
          <p class="mb-3">I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents.</p> <a class="btn btn-primary" href="#">Call to action</a>
        </div>
      </div>
    </div>
  </div>
