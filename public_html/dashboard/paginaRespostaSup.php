					...
					<div class="card-header">
						...
						foreach ($registro as $cliente) {
							...
							<div class="card-body">
								...
								<label style="font-weight: bold">Produto: </label> <p><?=$cliente['maquina']?></p>
								<label style="font-weight: bold">Descrição: </label> <p><?=$cliente['problema']?></p>
								<label style="font-weight: bold">Data: </label> <p><?=$cliente['descricao']?></p>
								</blockquote>
							</div>
						</div>   <?php } ?><br>
