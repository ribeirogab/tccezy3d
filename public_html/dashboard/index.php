      ...
      <div class="row">
        ...
        <div class="col-lg-6 mb-4">
          ...
          <div class="row">
            ...
            ?>
            <div class="col-lg-6 mb-4">
              <div class="card bg-browser text-white shadow" onclick="window.open('https://www.google.com/search?q=ezy3d&oq=ezy3d+&aqs=chrome..69i57j69i60l5.1854j0j9&sourceid=chrome&ie=UTF-8', '_blank')">
                <div class="card-body">
                  Browser
            ...
            <div class="col-lg-6 mb-4">
              <div class="card bg-face text-white shadow" onclick="window.open('https://www.facebook.com/EZY3DPRINTING/', '_blank')">
                <div class="card-body">
                  Facebook
            ...
            <div class="col-lg-6 mb-4">
              <div class="card bg-insta text-white shadow" onclick="window.open('https://www.instagram.com/ezy3d/', '_blank')">
                <div class="card-body">
                  Instagram
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    foreach ($mesesAnteriores as $mesTable) { ?>
                      <tr>
                        <td>
                          <span class="d-none"><?= $mesTable["mes"] . "</span>
