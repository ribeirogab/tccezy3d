...
<body class=bg-dark>
    <main>
        ...
        <div class="text-center text-md-right" style="height: 100vh;background-image: linear-gradient(to bottom, #333, #fa5f32 );">
            <div class="container">
                <div class="row">
                    <div class="mx-auto mx-md-0 ml-md-auto col-10 col-md-9">
                        <h3 style="margin-top: 35vh">
                            Orçamento enviado com sucesso, aguarde a resposta em seu email.<br>
