...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #191919;">
   <div class="container">
    <a class="navbar-brand active" href="index.php"><img src="img/logoHeader_laranja.png" width="80px"></a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-4" id="img-printer">
          <img class="float-right" src="img/e1260t_aberta.png" width="68%">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
      ...
      <div class="card cardPrinter">
        <div class="card-body">
          <div class="img-printer">
            <img src="img/printer1.png" class="img-printer" alt="">
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="img-printer1">
        <img src="img/printer1.png" class="img-printer1" alt="">
      </div>
  ...
  <div class="mt-5" id="info">
    <div class="card-group container">
      ...
      <div class="card cardEx mr-4">
        <img class="card-img-top" src="img/odontologia.jpg" alt="Imagem de capa do card">
        <div class="card-body">
          <h4 class="card-title">
            Odontologia
          </h4>
      ...
      <div class="card cardEx mr-4">
        <img class="card-img-top" src="img/joalheria.jpg" alt="Imagem de capa do card">
        <div class="card-body">
    ...
    <div class="card cardEx mr-4">
      <img class="card-img-top" src="img/manufatura.jpg" alt="Imagem de capa do card">
      <div class="card-body">
    ...
    <div class="card cardEx">
      <img class="card-img-top" src="img/educacao.jpg" alt="Imagem de capa do card">
      <div class="card-body">
...
<div class="container mb-5">
  <center><h1 class="mt-lg-5 display-3" id="custoBeneficio">O Melhor Custo/Beneficio</h1></center>
