    ...
    <div class="py-5" style="background-image: linear-gradient(30deg, #bc5453, #333 );">
      <div class="container">
        <div class="row">
          ...
          <div class="p-5 bg-white text-black ml-auto col-md-5 border">
            <h1>
              <?php
echo $titulo1;
if (isset($_SESSION['idadmin'], $_GET["alterartxt"])) {
    ...
    <div class="py-3 text-center bg-light">
      <div class="container">
        <div class="row text-muted">
          ...
          <div class="col-md-3 col-4 p-2">
            <i onclick="window.location.href='app_engenharia.php'" class="d-block fas fa-cog fa-3x icone-app" style="color: #f38919"></i>
          </div>
          <div class="col-md-3 col-4 p-2">
...
?>
      ...
      <div class="row">
        <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft2.jpg" width="1500">
          <h4 class="mt-3 mb-0">
          <b>
            <?php
echo $titulo3_1;
...
?>
        ...
        <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft3.jpg" width="1500">
          <h4 class="mt-3 mb-0">
          <b>
            <?php
echo $titulo3_2;
...
?>
        ...
        <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft4.jpg" width="1500">
          <h4 class="mt-3 mb-0">
          <b>
            <?php
echo $titulo3_3;
...
?>
        ...
        <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft5.jpg" width="1500">
          <h4 class="mt-3 mb-0">
          <b>
            <?php
echo $titulo3_4;
...
?>
  ...
  <div class="py-4 bg-light">
    <div class="container">
      <div class="row">
        <div class="col-6 p-3"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft6.jpg"> </div>
        <div class="col-6 p-3"> <img class="img-fluid d-block box-shadow" src="vendor/img/app_engenharia/ft7.jpg"> </div>
      </div>
    </div>
  </div>
  <div class="py-5 bg-white text-black">
