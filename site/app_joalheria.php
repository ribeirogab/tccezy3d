...
?>
  <main>
    ...
    <div class="py-5 text-center text-md-right" style="background-image: linear-gradient(to bottom, #333, #fa5f32 );">
      <div class="container">
        <div class="row">
    ...
    <div class="py-3 text-center bg-light">
      <div class="container">
        <div class="row text-muted">
          ...
          <div class="col-md-3 col-4 p-2">
            <i onclick="window.location.href='app_joalheria.php'" class="d-block fas fa-gem fa-3x icone-app" style="color: #f38919"></i>
          </div>
          <div class="col-md-3 col-4 p-2">
