...
<body>
  ...
  <nav class="fixed-top p-2 d-lg-block d-md-block d-none" style="background-color: #212121;">
    <div class="container" id="desktop">
      <a class="py-2 mr-5 float-left">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="d-block" role="img" viewBox="0 0 24 24" focusable="false"><title>Product</title><circle cx="12" cy="12" r="10"/><path d="M14.31 8l5.74 9.94M9.69 8h11.48M7.38 12l5.74-9.94M9.69 16L3.95 6.06M14.31 16H2.83m13.79-4l-5.74 9.94"/></svg>
      </a>
      <a class="py-2 mr-5 float-left">Impressoras 3D</a>
      <a class="py-2 mr-5 float-left">Acessórios</a>
      <a class="py-2 mr-5 float-left">Aplicações</a>
      <a class="py-2 mr-5 float-left">Contato</a>
      <a class="py-2 float-right"><i class="fas fa-globe"></i> PT <i class="fas fa-sort-down"></i></a>
      <a class="py-2 mr-5 float-right"><i class="fas fa-user-circle"></i> Conta <i class="fas fa-sort-down"></i></a>
    </div>
  </nav>
