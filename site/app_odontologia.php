 ...
 <main class="pt-64px">
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-md-8 mx-auto">
          ...
          <h1 class="display-3 mb-4">Odontologia</h1>
  ...
  <div class="py-5 text-center">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-8 order-2 order-lg-1">
  ...
  <div class="pt-3 pb-5" style="">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid d-block mt-3" src="https://static.pingendo.com/img-placeholder-1.svg">
        </div>
        <div class="col-md-4">
          <img class="img-fluid d-block mt-3" src="https://static.pingendo.com/img-placeholder-1.svg">
        </div>
  ...
  <div class="py-3 text-center bg-light">
    <div class="container">
      <div class="row text-muted">
        <div class="col-md-3 col-4 p-2"> <i class="d-block fa fa-paypal fa-3x"></i> </div>
        <div class="col-md-3 col-4 p-2"> <i class="d-block fa fa-empire fa-3x"></i> </div>
        <div class="col-md-3 col-4 p-2"> <i class="d-block fa fa-rebel fa-3x"></i> </div>
        <div class="col-md-3 col-4 p-2"> <i class="d-block fa fa-first-order fa-3x"></i> </div>
      </div>
    </div>
  </div>
