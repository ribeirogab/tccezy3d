    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          ...
          <p class="lead mb-2">I am alone, and feel the charm of existence in this spot.</p> <img class="img-fluid d-block mx-auto" src="https://static.pingendo.com/img-placeholder-tablet.svg" width="750" style="">
        </div>
      </div>
    </div>
  </div>
